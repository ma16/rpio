...
void Rpi::Gpio::enable(uint32_t set,bool on)
{
  enable<Gpio::Event::     Rise>(set,on) ;
  enable<Gpio::Event::     Fall>(set,on) ;
  enable<Gpio::Event::     High>(set,on) ;
  enable<Gpio::Event::      Low>(set,on) ;
  enable<Gpio::Event::AsyncRise>(set,on) ;
  enable<Gpio::Event::AsyncFall>(set,on) ;
}
