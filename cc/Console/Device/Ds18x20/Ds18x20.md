...
The table below list examples of digital output data and the corresponding temperature reading for a 9-bit resolution:
...
The table below list examples of digital output data and the corresponding temperature reading for a 12-bit resolution:
...
A parasite-powered circuit won't provide all operations and needs explicit power switching of the bus line.
