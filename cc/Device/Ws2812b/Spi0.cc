...
void Device::Ws2812b::Spi0::BitStream::push_back(bool bit,double ticks)
{
...
void Device::Ws2812b::Spi0::BitStream::push_back(Timing const &t,double f,uint32_t rgb)
{
...
void Device::Ws2812b::Spi0::BitStream::push_back(Timing const &t,double f,uint32_t rgb,size_t n)
{
    for (unsigned i=0 ; i<n ; ++i)
	this->push_back(t,f,rgb) ;
}

std::vector<uint8_t> Device::Ws2812b::Spi0::BitStream::to_uint8() const
{
...
void Device::Ws2812b::Spi0::send(uint32_t nleds,uint32_t rgb)
{
    BitStream q ;
