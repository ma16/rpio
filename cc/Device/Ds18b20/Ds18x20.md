...
The first eight significant bits provide the integer part of the temperature in °C, remaining bit present the fractional part.

Bits | Fractional Increments
---: | ---:
9 |  0.5°C
10 | 0.25°C
11 | 0.125°C
...
The table below list examples of digital output data and the corresponding temperature reading for numbers with 12 signifcant bits (DS18B20):
...
The table below list examples of digital output data and the corresponding temperature reading for numbers with 9 significant bits (DS18S20):
