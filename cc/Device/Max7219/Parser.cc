...
int Device::Max7219::Parser::next_char()
{
    int c = this->is->get() ;
...
Device::Max7219::Parser::Command::shared_ptr
Device::Max7219::Parser::parse()
{
    while (true)
    {
...
std::string Device::Max7219::Parser::scan(char const *set)
{
    int c = this->next_char() ;
    while (isspace(c)) 
	c = this->next_char() ;
...
void Device::Max7219::Parser::parse_comment()
{
    std::ostringstream os ; 
    while (true)
    {
...
Device::Max7219::Parser::Command::shared_ptr
Device::Max7219::Parser::parse_delay()
{
...
Device::Max7219::Parser::Command::shared_ptr
Device::Max7219::Parser::parse_echo()
{
    std::ostringstream os ; 
    while (true)
    {
...
Device::Max7219::Parser::Command::shared_ptr
Device::Max7219::Parser::parse_shift()
{
