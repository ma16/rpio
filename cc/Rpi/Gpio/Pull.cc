...
{
    auto control = gpio.at<Register::Gpio::Pull::Control>() ;

    auto bank0 = gpio.at<Register::Gpio::Pull::Bank0>() ;
    auto bank1 = gpio.at<Register::Gpio::Pull::Bank1>() ;
